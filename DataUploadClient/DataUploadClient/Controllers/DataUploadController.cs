    ...
    public class DataUploadController : Controller
    {
        ...
        {   
            ...
            string fileName = generateNewFileName(fileUploadModel);
                ...
                return RedirectToAction("Summary", new { fileName = fileName, testType = fileUploadModel.selectedTestType });
        }
        ...
        public ActionResult Summary(string fileName, string testType)
        {
