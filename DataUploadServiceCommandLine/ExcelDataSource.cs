...
namespace DataUploadService
{
    public class ExcelDataSource
    {
        ...
        private string getCellValue(DataTable table, int row, int column)
        {
        ...
        private int getTableIndexByName(DataSet dataSet, string tableName)
        {
        ...
        private int getTestResultColumnIndex(DataTable sheet, string columnName)
        {
